<?php
  ...
  function validate_admin($admin,  $options = []) {
    ...
    if(is_blank($admin['password'])) {
      ...
      $errors[] = "Password not in right format. It must contain upper and lower case, numbers, special characters.";
  ...
  function shift_subject_positions($start_pos, $end_pos, $current_id = 0) {
    ...
    if($start_pos == 0){
      ...
      //move earlier, +1 from items between (including $end_pos)
