...
//echo "protected b: {$example->b}<br />"; --cannot be accessed
//echo "private c: {$example->c}<br />"; --cannot be accessed
$example->show_abc();
echo "<br />";
echo "hello_everyone: {$example->hello_everyone()}<br />";
//echo "hello_family: {$example->hello_family()}<br />"; --cannot be accessed
//echo "hello_me: {$example->hello_me()}<br />"; --cannot be accessed
echo $example->hello();
?>